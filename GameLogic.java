...
public class GameLogic {
	...
	public static int getTime(){return timeCounter;}
	...
	static Timeline timeline = new Timeline(new KeyFrame(Duration.seconds(120),ev ->{
		togglePlayer();
	}));
	static Timeline timeline2 = new Timeline(new KeyFrame(Duration.seconds(1),ev ->{
		Abalone_main.decrementTime();
	}));
